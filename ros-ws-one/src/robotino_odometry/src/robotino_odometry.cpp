...
public:
    RobotinoOdometry()
    {
        ...
        */
        error_angle_dot = PI/3 / 7.5; //This is given just for an example, change this value.
        /*    
        ...
        */
        Flon = 1; // replace this value with the value found from the equation 11 in the paper.
