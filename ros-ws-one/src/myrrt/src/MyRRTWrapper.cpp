...
int main(int argc, char** argv)
{
	...
	ros::Publisher gotoCommandPub = nh.advertise<geometry_msgs::Pose>("/RRTgotoPose", 10);
	ros::Subscriber gotoCompletedSubs = nh.subscribe("/RRTgotoPoseCompleted", 10, gotoCommandCompletedCallback);
